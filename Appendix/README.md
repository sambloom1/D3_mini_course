...
### Basic elements that can be applied to an SVG element 
...
**group <g></g>** a g element froups all elements together around the brackets they encapuslate. the attriubutes are set in the opening g tag <g..> <br>
